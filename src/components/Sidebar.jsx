export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-full bg-white shadow-lg z-50 w-16 flex flex-col">
      {/* Sidebar Header */}
      ...
      <nav className="flex flex-col py-4 gap-2">
        ...
        {/* Products */}
        <div className="px-2">
          <a href="#" className="flex items-center justify-center p-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
